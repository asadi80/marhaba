    ...
    >
      ...
      <main className="max-w-[1100px] mx-auto px-4 md:px-6 py-7">
        ...
        <div className="mb-6 animate-[fadeUp_0.45s_cubic-bezier(0.22,1,0.36,1)_both]">
          ...
          <h1
            className={`font-light text-[clamp(24px,4vw,36px)] text-[#111118] leading-tight ${
              isAr
          ...
          <form onSubmit={handleSearch}>
            <div className="flex flex-wrap gap-2.5 items-end">
              ...
              <div className="shrink-0">
                <button
                  type="submit"
                  className={`bg-[#1a1a2e] text-[#e8c547] border-none rounded-lg py-2.5 px-[22px] text-[13px] cursor-pointer whitespace-nowrap inline-flex items-center gap-1.5 transition-all hover:opacity-88 hover:-translate-y-px ${
                    isAr
                      ? "font-['Cairo','Tajawal',sans-serif]"
        ...
        {!loading && listings.length > 0 && (
          <div className="text-xs text-[#999] mb-4 animate-[fadeUp_0.45s_cubic-bezier(0.22,1,0.36,1)_0.07s_both]">
            {listings.length} {listings.length === 1 ? t.listing : t.listings}{" "}
            {t.found}
            {filters.location && (
              <>
                {" "}
                {t.in}{" "}
                <span className="text-[#111118]">{filters.location}</span>
              </>
            )}
          </div>
        )}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-black/[0.06]">
                      ...
                      <div className="flex items-center gap-1.5">
                        <div
                          className={`w-[22px] h-[22px] rounded-full flex items-center justify-center text-[10px] font-medium shrink-0 ${hostAvi.bg} ${hostAvi.color}`}
                        >
                          {hostInitial}
                        </div>
