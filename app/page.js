    ...
    >
      ...
      >
        <div className="max-w-screen-xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
          <Link
            href="/"
            className="font-['Cairo','Tajawal',sans-serif] font-medium text-[30px] text-black tracking-[1px] flex-shrink-0 no-underline"
          >
      ...
      <div className="bg-[#1a1a2e] my-10 py-12 px-6">
        <div className="max-w-3xl mx-auto grid grid-cols-3 gap-6 text-center">
          {[
            ...
            <div key={label}>
              <div
                className={`font-light text-[44px] leading-none text-white mb-1.5 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
              >
                {val}
