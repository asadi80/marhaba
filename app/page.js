...
export default function Home() {
  ...
  return (
    ...
    >
      {/* ── NAV ─────────────────────────────────────────────────────────── */}
      <nav
        className={`sticky top-0 z-50 bg-white transition-all duration-200 ${scrolled ? "border-b border-gray-200 shadow-sm" : "border-b border-transparent"}`}
      >
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {isLoggedIn ? (
              ...
              <>
                <Link
                  href="/login"
                  className="text-[13px] font-medium text-gray-900 no-underline px-3 py-2 rounded-3xl hover:bg-gray-100 transition-colors"
                >
                  {content.signIn}
                </Link>
                <Link
                  href="/signup"
                  className="bg-[#1a1a2e] text-yellow-400 px-[18px] py-2.5 rounded-3xl text-[13px] font-semibold no-underline"
                >
                  {content.getStarted}
                </Link>
              </>
      ...
      <section className="relative min-h-[580px] flex items-center overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#2d2d5e] to-[#1a1a2e]">
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 py-20 w-full">
          ...
          <h1
            className={`font-light text-[clamp(40px,6vw,72px)] text-white leading-[1.1] max-w-[640px] mb-5 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
          >
          ...
          {!isLoggedIn ? (
            <div className="flex gap-3 flex-wrap">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 bg-yellow-400 text-[#1a1a2e] px-7 py-3.5 rounded-xl text-sm font-semibold no-underline hover:bg-yellow-300 hover:-translate-y-px transition-all"
              >
                {content.createAccount} →
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 bg-white/10 text-white px-7 py-3.5 rounded-xl text-sm font-medium no-underline border border-white/20 hover:bg-white/15 transition-colors"
              >
                {content.signIn}
              </Link>
            </div>
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            <h2
              className={`font-light text-[clamp(22px,3vw,30px)] text-gray-900 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
            >
              {activeCategory
                ? isAr
      ...
      <div className="bg-[#1a1a2e] my-10 py-12 px-6">
        <div className="max-w-3xl mx-auto grid grid-cols-3 gap-6 text-center">
          {[
            ...
            <div key={label}>
              <div
                className={`font-light text-[44px] leading-none text-white mb-1.5 ${
                  isAr
              ...
              <div className="text-[12px] tracking-widest uppercase text-white/40">
                {label}
              </div>
            </div>
          ))}
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-5">
          ...
          <div className="rounded-[20px] p-9 relative overflow-hidden min-h-[340px] flex flex-col justify-end bg-gradient-to-br from-[#e6f3ff] to-[#cce4ff]">
            <div
              className={`text-5xl absolute top-7 ${isAr ? "left-7" : "right-7"}`}
            >
              ✈️
            </div>
            ...
            <div
              className={`font-light text-[26px] leading-[1.2] text-gray-900 mb-3 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
            >
          ...
          <div className="rounded-[20px] p-9 relative overflow-hidden min-h-[340px] flex flex-col justify-end bg-gradient-to-br from-[#1a1a2e] to-[#2d2d5e]">
            ...
            <div
              className={`font-light text-[26px] leading-[1.2] text-white mb-3 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
            >
              {content.hostTagline}
            </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6">
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-5">
            {[
              ...
              <div
                key={name}
                className="bg-gray-50 rounded-2xl p-6 border border-black/[0.07] hover:shadow-lg transition-shadow"
              >
                ...
                <p className="text-sm text-gray-500 leading-[1.75] mb-5">
                  "{quote}"
                </p>
                <div className="flex items-center gap-3">
                  <div
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-10">
          <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#2d2d5e] rounded-3xl px-12 py-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h2
                className={`font-light text-[clamp(28px,5vw,44px)] text-white mb-3 leading-[1.15] ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
              >
                {content.ctaTitle}
              </h2>
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                <Link
                  href="/signup"
                  className="bg-yellow-400 text-[#1a1a2e] px-7 py-3.5 rounded-xl text-sm font-bold no-underline"
                >
                  {content.createAccount} →
                </Link>
                <Link
                  href="/login"
                  className="bg-white/10 text-white px-7 py-3.5 rounded-xl text-sm font-medium no-underline border border-white/20"
                >
                  {content.signIn}
                </Link>
              </div>
      ...
      <footer className="bg-[#111] px-6 pt-12 pb-7">
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-8 mb-10 pb-10 border-b border-[#222]">
            <div>
              <div
                className={`font-light text-[22px] text-white mb-3 ${isAr ? "font-[Cairo,Tajawal,sans-serif]" : "font-[Fraunces,serif] italic"}`}
              >
             <Link
            href="/"
            style={{
